...
html을 심도 있게 공부하지 않았기 때문에, 간혹 웹 UI 화면을 개발할 때 이미지 파일을 배치해야 하는 경우가 있는데... 항상 구글링을 하면서 대충 이미지를 때려박는 식으로 개발한 경험이 있습니다. 그래서 오늘은 html/css에서 기본적으로 레이아웃을 배치할 때 유용한 프로퍼티인 position 프로퍼티에 대해서 살펴보았습니다.
