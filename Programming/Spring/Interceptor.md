...
세션 검증 후 로그인 인증이 되어있다면 해당 사용자 정보를 세션에 저장하는 로직을 넣을 수도 있습니다. 또한 view에 전달할 ModelAndView 객체를 이용해서 특정 작업을 수행할 수도 있습니다.
...
> boot 2.0 + Java 1.8 + spring 5.0 이상의 버전을 사용하면서 WebMvcConfigurer의 대부분 메서드가 default로 선언되었습니다. 덕분에 모든 메서드를 구현해야 하는 강제력이 사라졌습니다. 필요한 메서드만 선택해서 오버라이드하면 됩니다.
